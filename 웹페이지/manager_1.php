...
$query1 = "SELECT ODR_NO, ODR_TIME, BRANCH_NAME FROM ODR, BRANCH
	WHERE ODR_STATUS_CD = 'CD0501'
	AND ODR.BRANCH_NO = BRANCH.BRANCH_NO";

$query2 = "SELECT ODR.ODR_NO, ITEM_NAME, QTY, BRANCH_NAME FROM ITEM, ODR, ODITEM, BRANCH
	WHERE ODR_STATUS_CD = 'CD0501'
	AND ODITEM.ODR_NO = ODR.ODR_NO
