...
$query = "SELECT ITEM_NAME, QTY, RETURN_TIME, RETURN_STATUS_CD FROM ITEM, RETURN, RTITEM
	WHERE BRANCH_NO IN (SELECT BRANCH_NO FROM BRANCH WHERE BRANCH_LOGIN_ID = :user_id)
	AND RETURN.RETURN_NO = RTITEM.RETURN_NO
