...
$query = "SELECT CHNG_TIME, CHNG_AMT, CHNG_DIV_CD, BRANCH_NAME FROM PTCHNGHIS, BRANCH
	WHERE CUSTOM_NO IN (SELECT CUSTOM_NO FROM CUSTOM WHERE CUSTOM_LOGIN_ID = :user_id)
	AND PTCHNGHIS.BRANCH_NO = BRANCH.BRANCH_NO ORDER BY CHNG_TIME DESC";
      ...
      <div class="container-fluid">
        <h1 class="mt-4">-포인트변경기록확인-</h1>
			...
			while($row = oci_fetch_array($result,OCI_ASSOC)){
				echo("<tr><td>$row[CHNG_TIME]</td>
				<td>$row[CHNG_AMT]</td>
				<td>$row[CHNG_DIV_CD]</td>
